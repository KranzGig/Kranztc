...
$servername = "127.0.0.1:3306";
    ...
    while($row = $result->fetch_assoc()) {
      ...
      $mail->Subject = "Martha Carter - Caretaker Hours Logged for Week of ".$firstdate." (Manually Generated)";
      $mail->Body = "Hi ".$row['name'].",\n\nAttached is Martha Carter's caretaker time-tracking report for the week of ".$firstdate.".\nThis copy has been manually generated by the administrator for the purposes of sending updated/corrected hours, sending a report if the automated message wasn't received, or sending an extra copy if requested.\nIf you have any questions or concerns, please contact Cathy Limbach at cllbach@comcast.net.\n\nThanks and Best Regards,\nDocument Hours Time Tracking Team";      
